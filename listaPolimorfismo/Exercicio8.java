...
class Gerente extends Funcionario {
    private final double adicionalGerente = 1500.0;
    ...
    @Override
    public double rendaTotal() {
        return getRendaBasica() + adicionalGerente;
    }
}

class Supervisor extends Funcionario {
    private final double adicionalSupervisor = 600.0;
    ...
    @Override
    public double rendaTotal() {
        return getRendaBasica() + adicionalSupervisor;
    }
}

class Vendedor extends Funcionario {
    private final double adicionalVendedor = 250.0;
    ...
    @Override
    public double rendaTotal() {
        return getRendaBasica() + adicionalVendedor;
    }
}
